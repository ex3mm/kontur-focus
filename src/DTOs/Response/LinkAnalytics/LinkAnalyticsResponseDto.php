 ...
 */
final readonly class LinkAnalyticsResponseDto
{
    use HasRawResponse;
    ...
    public function __construct(
        ...
        public ?LinkAnalyticsResponseLinkAnalyticsDataDto $linkAnalyticsData = null,
    ...
    public function withRawResponse(string $raw): static
    {
        ...
        return new static(
            ...
            linkAnalyticsData: $this->linkAnalyticsData,
            raw: $raw,
        );
    }
