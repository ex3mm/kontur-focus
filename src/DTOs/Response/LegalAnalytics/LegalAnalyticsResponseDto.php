 ...
 */
final readonly class LegalAnalyticsResponseDto
{
    use HasRawResponse;
    ...
    public function __construct(
        ...
        public ?LegalAnalyticsResponseLegalAnalyticsDataDto $legalAnalyticsData = null,
    ...
    public function withRawResponse(string $raw): static
    {
        ...
        return new static(
            ...
            legalAnalyticsData: $this->legalAnalyticsData,
            raw: $raw,
        );
    }
