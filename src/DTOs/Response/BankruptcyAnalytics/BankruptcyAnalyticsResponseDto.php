 ...
 */
final readonly class BankruptcyAnalyticsResponseDto
{
    use HasRawResponse;
    ...
    public function __construct(
        ...
        public ?BankruptcyAnalyticsResponseBankruptcyAnalyticsDataDto $bankruptcyAnalyticsData = null,
    ...
    public function withRawResponse(string $raw): static
    {
        ...
        return new static(
            ...
            bankruptcyAnalyticsData: $this->bankruptcyAnalyticsData,
            raw: $raw,
        );
    }
