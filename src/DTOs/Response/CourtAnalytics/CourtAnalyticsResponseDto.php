 ...
 */
final readonly class CourtAnalyticsResponseDto
{
    use HasRawResponse;
    ...
    public function __construct(
        ...
        public ?CourtAnalyticsResponseCourtAnalyticsDataDto $courtAnalyticsData = null,
    ...
    public function withRawResponse(string $raw): static
    {
        ...
        return new static(
            ...
            courtAnalyticsData: $this->courtAnalyticsData,
            raw: $raw,
        );
    }
