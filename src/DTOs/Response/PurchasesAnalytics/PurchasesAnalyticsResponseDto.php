 ...
 */
final readonly class PurchasesAnalyticsResponseDto
{
    use HasRawResponse;
    ...
    public function __construct(
        ...
        public ?PurchasesAnalyticsResponsePurchasesAnalyticsDataDto $purchasesAnalyticsData = null,
    ...
    public function withRawResponse(string $raw): static
    {
        ...
        return new static(
            ...
            purchasesAnalyticsData: $this->purchasesAnalyticsData,
            raw: $raw,
        );
    }
